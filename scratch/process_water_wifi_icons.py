...
files = [
    ("water_wifi_dolphin_v1_1786321672839.jpg", "water_wifi_dolphin_optA_transparent.png"),
    ("water_wifi_dolphin_v2_1786321685889.jpg", "water_wifi_dolphin_optB_transparent.png"),
]
...
# Automatically set Option A as default project icons
default_icon = Image.open(os.path.join(brain_dir, "water_wifi_dolphin_optA_transparent.png"))
...
print("Project icons updated with Water Wi-Fi Option A!")
