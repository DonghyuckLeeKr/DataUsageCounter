...
// Scans common USB LTE Router Gateway IPs to query device SIM carrier info

const COMMON_ROUTER_IPS = [
  { ip: '192.168.8.1', name: 'Huawei / HiLink Router' },
  { ip: '192.168.0.1', name: 'LG U+ Egg / ZTE Router' },
...
export const detectLteRouterCarrier = async () => {
      ...
      for (const url of endpoints) {
        try {
          ...
          if (res) {
            ...
            // Based on IP subnet heuristics & LTE dongle profiles
  ...
  return {
    detected: true,
    gatewayIp: '192.168.0.1 (USB Tethering RNDIS)',
